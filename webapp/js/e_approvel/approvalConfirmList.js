 ...
 * </pre>
 */ 
const APPROVALCONFIRMLISTTABLE = $('#approvalConfirmListTable'); 

const listBody = $("#listBody");


$.approvalConfirmList=function(){
	$.ajax({
		url : $.getContextPath() + "/approval/confirm.do",
		data:{memId : memId},
		dataType : "json",
		success : function(resp) {
			...
			let table = APPROVALCONFIRMLISTTABLE.DataTable({
				paging : true,
				search : true,
			...
			.buttons().container().appendTo("#approvalConfirmListTable_wrapper .col-md-6:first");
		}
	}); // ajax end
