		...
		<div class="container ">
			<div class="construction1 text-center details text-white">
				<div class="row align-items-center">
					...
					<div class="col-lg-12 ">
						<h1>죄송합니다. 현재 사용자께서는 이 페이지에 접근할 권한이 없습니다.</h1>
						<h6 class="tx-15 mt-3 mb-4 text-white-50">주소를 잘못 입력했거나 페이지가 이동했을 수 있습니다. 아래에서 검색해보세요.</h6>
						<a class="btn ripple btn-success text-center" href="${pageContext.request.contextPath}/home">홈으로가기</a>
					</div>
				</div>
			</div>
		</div>
