...
<body class="main-body leftmenu">
								...
								<div class="row row-sm">
									<div class="card-body mt-2 mb-2">
										...
										<form id="findIdForm" action="${pageContext.request.contextPath }/login/loginProcess.do" method="post">
											<h5 class="text-left mb-2" style="font-weight: bold;">비밀번호 찾기</h5>
											<div id="usernameDiv" class="form-group text-left">
												<label>아이디(사번)</label>
												<input class="form-control" name="username" id="username" placeholder="아이디(사번)를 입력하세요" type="text">
											</div>
											...
											<button type="button" class="btn ripple btn-main-primary btn-block" id="checkIdBtn">다음</button>
										</form>
									</div>
								</div>
							</div>
	...
	<script src="${pageContext.request.contextPath}/js/sign/findPass.js"></script>
